...
const AboutusSection = () => {
  return (
    ...
    <div className="w-full">
        <div className="py-20  flex flex-col justify-between mx-auto items-center">
          <h1 className="text-5xl font-semibold text-center headings">About Us</h1>
         
          {/* Responsive Flex Container for Stats */}
          <div className="grid grid-cols-9 gap-4  justify-center items-start mt-10 ">
            <div className='col-span-5 flex flex-col px-10  text-justify justify-center items-center mt-10'>
