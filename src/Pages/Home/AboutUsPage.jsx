          ...
          <div>
            <p className="text-lg p-4 md:p-8">
              ...
              <p className="text-xl text-justify">
                ...
                incorporated in the year 2006. The company was founded by Mr. Chander
                Mohan. Chander Mohan is the managing director of the company,
                till date the company has done more than 2 lac sq ft of plots and
                real estate development in Delhi, NCR, Uttarakhand, Bhopal,
                Rajasthan, Vrindavan, Goa, etc. They have delivered 6+ projects
                including plots and residential. The company is currently
                executing a 70-acre township in Haridwar named Haridwar
                Paradise and has upcoming projects in Rishikesh and Devprayag.
              </p>
            </p>
          </div>
