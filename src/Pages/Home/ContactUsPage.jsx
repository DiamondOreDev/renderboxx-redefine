...
const ContactUsPage = () => {
  return (
      ...
      <div className="relative  h-screen">
        <div className="relative w-full h-2/4">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center mt-20">
            ...
            <h1 className="text-white text-8xl font-bold headings">Contact US</h1>
          </div>
        </div>
    ...
    <iframe className="w-[91vw] mx-auto p-6 ml-20 overflow-hidden" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14021.334908844325!2d77.23933369831319!3d28.529687102942304!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce1638ba50b35%3A0x4ecd5ee2a5c81b24!2sDDA%20Flats%20Kalkaji%2C%20Harijan%20Colony%2C%20Block%20B%2C%20Kalkaji%2C%20New%20Delhi%2C%20Delhi%20110019!5e0!3m2!1sen!2sin!4v1724747481095!5m2!1sen!2sin" width="600" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      ...
      <div className="relative h-[400px] mb-10">
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-start mt-12">
            <div className="grid grid-cols-6 gap-20 ml-32">
